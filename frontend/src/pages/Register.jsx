...
import { Compass, User, Mail, Lock, ArrowRight, AlertCircle, Loader } from 'lucide-react';
    ...
    <div className="relative min-h-screen bg-darkBg flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">Create an account to start planning trips</p>
        </div>
        ...
        <div className="glass-panel rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-gray-300 text-xs font-semibold uppercase tracking-wider mb-2">Password (Min. 6 chars)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-500">
